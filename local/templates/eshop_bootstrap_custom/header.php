...
$folderCurrentPath = str_replace(realpath($_SERVER["DOCUMENT_ROOT"]), '', dirname(__FILE__));
...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="<?=$folderCurrentPath?>/images/favicon.604825ed.ico" />
			...
			<div class="row pt-0 pt-md-3 mb-3 align-items-center" style="position: relative;">
				...
				<div class="col-12 col-md-auto bx-header-logo">
					<a class="bx-logo-block d-none d-md-block" href="<?=SITE_DIR?>">
						<img src="<?=$folderCurrentPath?>/images/logo.png" srcset="<?=$folderCurrentPath?>/images/logo_retina.png" />
					</a>
					<a class="bx-logo-block d-block d-md-none text-center" href="<?=SITE_DIR?>">
						<img src="<?=$folderCurrentPath?>/images/logo_mobile.png" srcset="<?=$folderCurrentPath?>/images/logo_mobile_retina.png" />
					</a>
				</div>
